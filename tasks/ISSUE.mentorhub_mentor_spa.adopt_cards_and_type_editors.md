# Adopt spa_utils 0.5.0 cards and type-aligned editors (Mentor SPA)

## Summary
Bump `@mentor-forge/mentorhub_spa_utils` to **0.5.0** and adopt `MhCard` / `CardGrid` / `DataCard` plus configurator-type editors for list and view/edit pages in `mentorhub_mentor_spa`.
