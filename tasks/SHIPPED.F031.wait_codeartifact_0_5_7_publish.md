...
- `tasks/SHIPPED.F030.bump_patch_release_0_5_7.md`
...
**Publish confirmation (Mike Storey, 2026-07-31)**

- F030 PR https://github.com/mentor-forge/mentorhub_spa_utils/pull/28 merged to `main`.
- Release tag **`v0.5.7`** present on `mentorhub_spa_utils`.
- CodeArtifact publish confirmed by Mike; `@mentor-forge/mentorhub_spa_utils@0.5.7` available for downstream installs (`mh` + `npm install`).

**Follow-up:** mentee_spa **L125** — adopt CodeArtifact `0.5.7`, remove temporary `file:../mentorhub_spa_utils` link.
